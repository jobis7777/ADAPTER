...
// End Cross Module References
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ADonkeyKong_USFXCharacter_Statics::PropPointers[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ADonkeyKong_USFXCharacter_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UIProyectil_NoRegister, (int32)VTABLE_OFFSET(ADonkeyKong_USFXCharacter, IIProyectil), false },
		};
	...
	IMPLEMENT_CLASS(ADonkeyKong_USFXCharacter, 888686404);
